...
public class FlugerianSymbol extends ImageDrawable implements Swipeable {
	public final float finalX = (IScreen.glGraphics.getWidth()/2)-(width/2);
	
	public FlugerianSymbol(GLGame game, String filename) {
		super(game, filename, 196.0f*IScreen.SSC, 50.0f*IScreen.SSC);
		def.position = new Vec2(-width-20, IScreen.glGraphics.getHeight()*.4f*IScreen.SSC);
	}
