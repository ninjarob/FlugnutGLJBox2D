...
public class MainMenu extends ImageDrawable implements Swipeable{
	public final float finalX = (IScreen.glGraphics.getWidth()/2)-(width/2);

	public MainMenu(GLGame game, String filename) {
		super(game, filename, 192.0f*IScreen.SSC, 171.0f*IScreen.SSC);
		def.position = new Vec2(-width, 158*IScreen.SSC);
	}
