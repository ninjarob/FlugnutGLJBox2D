...
public class FlugnutLab extends Building {
    public PolygonShape ps;

    //FlugnutLevel\House.png
    //477X238
    public FlugnutLab(GLGame game, FlugnutWorld flugnutWorld) {
        super(game, Constants.F_LAB_STARTX, Constants.F_LAB_STARTY, Constants.F_LAB_WIDTH, Constants.F_LAB_HEIGHT,
                Constants.F_LAB_PATH, Constants.F_LAB_HEALTH);
        this.flugnutWorld = flugnutWorld;
        this.maxHealth = Constants.F_LAB_HEALTH;
        initPhysicsWorld();
    }
