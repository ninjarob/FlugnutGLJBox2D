...
public class Tower extends BuildingPiece {
    ...
    public Tower(GLGame game, float startx, float starty, FlugnutWorld flugnutWorld, Building building) {
        super(game, startx, starty,
                Constants.TOWER_WIDTH, Constants.TOWER_HEIGHT,
                Constants.TOWER_PATH, 0f, 0f, 1f, .45f);
    ...
    public Vec2[] getVerts() {
        ...
        verts[0] = new Vec2(-width/6, height/6);
        verts[1] = new Vec2(width/6, height/6);
        verts[2] = new Vec2(width/6, -height/6);
        verts[3] = new Vec2(-width/6, -height/6);
        return verts;
    }
